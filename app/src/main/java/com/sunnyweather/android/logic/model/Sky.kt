...
//转换函数，将天气代码转换成Sky对象，这个对象里面包含天气以及对应的图片信息
class Sky(val info: String, val icon: Int, val bg: Int)

private val sky = mapOf(
    "CLEAR_DAY" to Sky("晴", R.drawable.ic_clear_day, R.drawable.bg_clear_day),
    "CLEAR_NIGHT" to Sky("多云", R.drawable.ic_clear_night, R.drawable.bg_clear_night),
    ...
    "HAIL" to Sky("冰雹", R.drawable.ic_hail, R.drawable.bg_rain),
